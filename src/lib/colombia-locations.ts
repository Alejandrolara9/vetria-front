...
export const COLOMBIA_DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    cities: [
      ...
      "Angelópolis", "Angostura", "Anorí", "Anzá", "Apartadó", "Arboletes", "Argelia",
      ...
      "Guatapé", "Heliconia", "Hispania", "Itagüí", "Ituango", "Jardín", "Jericó",
      "La Ceja", "La Estrella", "La Pintada", "La Unión", "Liborina", "Maceo",
      "Marinilla", "Montebello", "Murindó", "Mutatá", "Nariño", "Nechí", "Necoclí",
      ...
      "San José de la Montaña", "San Juan de Urabá", "San Luis", "San Pedro",
  ...
  },
  {
    ...
    cities: [
      ...
      "Campohermoso", "Cerinza", "Chinavita", "Chíquiza", "Chiscas", "Chita",
      "Chitaraque", "Chivatá", "Ciénega", "Cómbita", "Coper", "Corrales",
      "Covarachía", "Cubará", "Duitama", "El Cocuy", "El Espino", "Firavitoba",
      ...
      "Socotá", "Socha", "Sogamoso", "Somondoco", "Sora", "Soracá", "Sotaquirá",
      "Susacón", "Sutamarchán", "Sutatenza", "Tasco", "Tenza", "Tibaná", "Tibasosa",
      "Tinjacá", "Tipacoque", "Toca", "Togüí", "Tópaga", "Tota", "Turmequé",
      "Tuta", "Tutazá", "Umbita", "Ventaquemada", "Villa de Leyva", "Viracachá",
      "Zetaquira",
    ],
  },
  {
  ...
  },
  {
    name: "Cundinamarca",
    cities: [
      "Soacha", "Agua de Dios", "Albán", "Anapoima", "Anolaima", "Apulo",
      ...
      "Útica", "Vergara", "Vianí", "Villagómez", "Villapinzón", "Villeta",
  ...
  },
  {
    name: "Guainía",
    cities: [
      "Puerto Inírida", "Barranco Minas", "Cacahual", "La Guadalupe",
      "Mapiripana", "Morichal", "Pana Pana", "San Felipe",
    ],
  },
  {
    name: "Guaviare",
  ...
  },
  {
    ...
    cities: [
      ...
      "Hobo", "Iquira", "Isnos", "La Argentina", "La Plata", "Nataga", "Oporapa",
  ...
  },
  {
    ...
    cities: [
      ...
      "Fuente de Oro", "Granada", "La Macarena", "La Uribe", "Lejanías",
  ...
  },
  {
    ...
    cities: [
      ...
      "Santo Domingo de Silos", "Sardinata", "Silos", "Teorama", "Tibú",
  ...
  },
  {
    name: "Tolima",
    cities: [
      "Ibagué", "Alpujarra", "Alvarado", "Ambalema", "Anzoátegui", "Ataco",
  ...
  },
  {
    ...
    cities: [
      ...
      "Riofrío", "Roldanillo", "San Pedro", "Santuario", "Sevilla", "Toro",
