      ...
      {client.portalStatus === "NOT_INVITED" && (
        <div className="px-4 pb-3 flex items-center gap-2 flex-wrap">
          <button
            ...
            disabled={inviting}
            className="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 bg-primary hover:bg-primary/90 text-white rounded-lg disabled:opacity-50 transition-colors"
          >
